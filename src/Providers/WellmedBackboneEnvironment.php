...
abstract class WellmedBackboneEnvironment extends BaseServiceProvider{
    protected $__config_wellmed_backbone = [];
    ...
    public function __construct(Container $app) {
        ...
        $this->__config_wellmed_backbone = $this->__config['wellmed-backbone'];
    }

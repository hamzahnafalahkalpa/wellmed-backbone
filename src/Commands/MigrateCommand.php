...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'wellmed-backbone:migrate {--seed}';
     ...
     * @var string
     */
    protected $description = 'Run migrations for the WellmedBackbone project';
    ...
    public function handle()
    {
        ...
        $this->info("Migrations for WellmedBackbone project have been successfully executed.");

        if ($this->option('seed')){
            $this->info("Run seeding");
            Artisan::call('wellmed-backbone:seed');
            $this->info("Seeded");
        }
        return Command::SUCCESS;
    }
